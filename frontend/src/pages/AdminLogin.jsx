  ...
  return (
    <div style={{ display: 'flex', height: '100vh', justifyContent: 'center', alignItems: 'center', background: '#f0f2f5' }}>
      <div style={{ background: '#fff', padding: '40px', borderRadius: 12, boxShadow: '0 2px 12px rgba(0,0,0,0.1)', width: 380 }}>
        <h2 style={{ textAlign: 'center', marginBottom: 24, color: '#333' }}>管理员登录</h2>
        <form onSubmit={handleLogin}>
          <div style={{ marginBottom: 16 }}>
            <input style={inputStyle} type="text" placeholder="管理员账号" value={username} onChange={e => setUsername(e.target.value)} required />
          </div>
          ...
          <button type="submit" style={{ ...btnStyle, background: '#E65100' }}>登 录</button>
        </form>
        <div style={{ textAlign: 'center', marginTop: 16, fontSize: 13, color: '#999' }}>
          <a href="/agent/login" style={{ color: '#4A90D9', textDecoration: 'none' }}>客服登录</a>
